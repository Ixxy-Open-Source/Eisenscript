...
public static class Matrix4x4Extension {
    ...
    /// </summary>
    /// <param name="rot">Rotation quaternion values</param>
    /// <param name="scale">Scale</param>
    public static void Decompose( this float3x3 pos, out float4 rot, out float3 scale)
    {
        var lenC0 = math.length(pos.c0);
        var lenC1 = math.length(pos.c1);
        var lenC2 = math.length(pos.c2);

        float3x3 rotationMatrix;
        rotationMatrix.c0 = pos.c0 / lenC0;
        rotationMatrix.c1 = pos.c1 / lenC1;
        rotationMatrix.c2 = pos.c2 / lenC2;
        ...
        rot = new quaternion(rotationMatrix).value;
    }
