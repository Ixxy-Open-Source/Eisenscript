...
namespace Eisenscript
{
    public class Rules
    {
        ...
        public Color Background { get; set; } = new();
        ...
        internal System.Random RndGeometry = new ();
        internal System.Random RndColors = new ();
        ...
        {
            RndGeometry = new System.Random(seed);
        }

        public void SetSeedColors(int seed)
        {
            RndColors = new System.Random(seed);
        }
